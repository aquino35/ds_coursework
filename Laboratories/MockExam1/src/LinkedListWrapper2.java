...
public class LinkedListWrapper2 {
    ...
    public static class SinglyLinkedList<E> implements List<E> {
        ...
        /*
         * Consider a member method findDuplicates which returns a new List with all the elements that appear more than once in the original list.
         * The resulting list itself cannot have duplicates.
         * If there are no duplicates, the method returns an empty list.
         * Implement this method for the SinglyLinkedList class.
         * For example, if L = {1, 0, 4, 3, 1, 1, 2, 4},
         * then L.findDuplicates() returns {1, 4}.
         */
        @Override
        public List<E> findDuplicates() {
            List<E> duplicates = new SinglyLinkedList<E>();
