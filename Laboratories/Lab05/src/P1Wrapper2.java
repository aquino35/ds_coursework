...
//                //if(i%2!=0) result.add(this.remove(i));
//                result.add(this.remove(i));
//            }
//            for (int j =0; j<result.size();++j){
//                this.add(result.get(j));
//            }

            List<E> result = new SinglyLinkedList<E>();
            for(int i=1; i<this.size(); ++i) result.add(this.remove(i));
            while(! result.isEmpty()) this.add(result.remove(0));
