...
public class SortedList1Wrapper {
    ...
    public static class CircularSortedDoublyLinkedList<E> implements SortedList<E> {
        ...
        public SortedList<E> nearestNeighbors(E e) {
            ...
            for (int index = this.firstIndex(e)-1; count < 2 && index >= 0; index--, count++)
                result.add(this.get(index));
            for (int index2 = this.firstIndex(e)+1; count2 < 2 && index2 < this.size(); index2++, count2++)
